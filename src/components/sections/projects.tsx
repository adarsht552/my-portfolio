      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <Card key={index} className="group overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 flex flex-col bg-secondary/20 backdrop-blur-lg border border-border/10">
